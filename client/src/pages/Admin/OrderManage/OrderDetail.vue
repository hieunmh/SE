      ...
      <div class="box-content">
        ...
        <div class="row" v-for="(o, index) in orderDetail.order_items" :key="index">
          ...
          <div class="centre col-sm-4 col-4">
            <h4 class="item-total fw-bold d-sm-none d-inline text-dark text-decoration-line-through" v-if="parseInt(o.product.price) != parseInt(o.product.salePrice)"> {{ o.product.price.toLocaleString("it-IT", { style: "currency", currency: "VND" }).slice(0, -3) }}&#8363;</h4>
            <h4 class="item-total fw-bold d-sm-none d-inline">{{ parseInt(o.product.salePrice).toLocaleString("it-IT", { style: "currency", currency: "VND" }).slice(0, -3) }}&#8363;</h4>
            <h4 class="item-name fw-bold">{{ o.product.name }}</h4>
          </div>


          <div class="centre col-sm-2 d-sm-flex d-none cal-total">
            <h4 class="item-total text-dark text-decoration-line-through fw-bold" v-if="parseInt(o.product.price) != parseInt(o.product.salePrice)"> {{ o.product.price.toLocaleString("it-IT", { style: "currency", currency: "VND" }).slice(0, -3) }}&#8363;</h4>
        ...
        <div class="row col-12">
          ...
          <div class="col-2 centre">
            <h4 class="fw-bold">{{ parseInt(orderDetail.total).toLocaleString("it-IT", { style: "currency", currency: "VND" }).slice(0, -3) }}&#8363;</h4>
          </div>
        </div>
      </div>
    </div>
