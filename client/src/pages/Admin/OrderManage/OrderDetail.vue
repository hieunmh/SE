      ...
      <div class="box-content">
        ...
        <div class="row" v-for="(o, index) in orderDetail.order_items" :key="index">
          ...
          <div class="centre col-sm-2 d-sm-flex d-none cal-total">
            <h4 class="item-total text-dark text-decoration-line-through fw-bold" v-if="parseInt(o.product.price) != parseInt(o.product.salePrice)"> {{ o.product.price.toLocaleString("it-IT", { style: "currency", currency: "VND" }) }}</h4>
